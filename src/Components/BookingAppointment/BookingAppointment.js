        ...
        <div className="container-box">
          <Row>
            <Col md={6} sm={6} className="side-text">
              <h1 className="white">Book</h1>
              <h1 className="white">your</h1>
              <h1 className="white">Appointment</h1>
              <h1 className="white">Today</h1>
            ...
            <Col
              ...
              className="form-bg-col form-box-container"
            >
